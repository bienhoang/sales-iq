...
- `references/examples-pricing-strategy.md` - Pricing strategy example
- `references/examples-campaign-diagnosis.md` - Campaign diagnosis example
- `references/examples-gtm-channel-strategy.md` - GTM channel strategy example
